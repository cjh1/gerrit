...
class ReviewerPredicate extends OperatorPredicate<TopicData> {
  private final Provider<ReviewDb> dbProvider;
  private final Account.Id id;

  ReviewerPredicate(Provider<ReviewDb> dbProvider, Account.Id id) {
    super(TopicQueryBuilder.FIELD_REVIEWER, id.toString());
  ...
  public boolean match(final TopicData object) throws OrmException {
    for (ChangeSetApproval p : object.approvals(dbProvider)) {
